"""
DAG de silver - Agregações e métricas
...
def create_dag():
    ...
    dag_config = config_loader.load_dag_config("silver")
    ...
    for task_config in dag_config["tasks"]:
        validate_task_config(task_config, "silver")
        ...
        task = BigQueryInsertJobOperator(
            ...
            configuration={
                "query": {
                    "query": f"{{% include 'silver/queries/{sql_filename}' %}}",
                    "useLegacySql": False,
                }
            },
